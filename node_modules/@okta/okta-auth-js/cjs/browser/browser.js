...
class OktaAuthBrowser extends _OktaAuthBase.default {
  constructor(args = {}) {
    super(Object.assign({
      ...
      storageUtil: args.storageUtil || _browserStorage.default,
    ...
    }, args)); // Add shims for compatibility, these will be removed in next major version. OKTA-362589
    ...
    this.options = Object.assign(this.options, {
      ...
      // PKCE defaults to true for browser
  ...
  async signOut(options) {
    ...
    var logoutUrl = (0, _oidc.getOAuthUrls)(this).logoutUrl;
  ...
  getOriginalUri() {
    ...
    const originalUri = storage.getItem(constants.REFERRER_PATH_STORAGE_KEY) || window.location.origin;
    return originalUri;
  }
...
OktaAuthBrowser.features = OktaAuthBrowser.prototype.features = features; // Also hoist values and utility functions for CommonJS users
